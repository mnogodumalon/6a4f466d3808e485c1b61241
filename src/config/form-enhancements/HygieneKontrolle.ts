// Auto-generated. Per-entity form-enhancements config for "Hygiene-Kontrolle".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["datum", "kontrollpunkt", "messwert", "in_ordnung", {"row": ["kontrolleur_vorname", "kontrolleur_nachname"]}, "bemerkung"],
  defaults: {
    'datum': { kind: 'today' },
    'in_ordnung': { kind: 'literal', value: true },
  },
  computed: {},
};
