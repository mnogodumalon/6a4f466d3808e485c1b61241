// Auto-generated. Per-entity form-enhancements config for "Kontrollpunkte".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['name', 'kategorie', 'sollwert', 'beschreibung'],
  defaults: {
    'kategorie': { kind: 'lookup', key: 'sonstiges', label: 'Sonstiges' },
  },
  computed: {},
};
